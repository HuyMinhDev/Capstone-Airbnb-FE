...
import ListBooking from "@/features/admin/ManagerBooking/components/ListBooking";
...
export default function ManagerBooking() {
  ...
  return (
    <div className="p-6">
      ...
      {/* Location List */}
      <ListBooking valueInput={valueInput} onEdit={handleOpenEdit} />
